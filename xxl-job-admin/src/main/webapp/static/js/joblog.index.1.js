        ...
        "columns": [
            {
                ...
                "render": function ( data, type, row ) {
                            ...
                            var childInfo=row.executorHandler?row.executorHandler:data;
                            return '<input type="checkbox" name="ids" value="'+row.id+'" >&nbsp;<a class="logTips" href="javascript:;" >'+ childInfo +'<span style="display:none;">'+ temp +'</span></a>';
                        }
					},
                    {
                        "data": 'childSummary',
