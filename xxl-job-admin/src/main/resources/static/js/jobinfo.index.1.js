$(function() {
	...
	$("#job_list").on('click', '.update',function() {
		...
		$('#updateModal .form select[name=alarmHookType] option[value='+ row.alarmHookType +']').prop('selected', true);
		$("#updateModal .form input[name='alarmHookUrl']").val( row.alarmHookUrl );
