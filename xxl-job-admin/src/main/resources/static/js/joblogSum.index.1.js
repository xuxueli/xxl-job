$(function() {
	...
	// init date tables
	var logTable = $("#joblogSum_list").dataTable({
	    "paging": false,  //不显示翻页按钮
		"deferRender": true,
		"processing" : true, 
	    "serverSide": true,
		"ajax": {
	        url: base_url + "/joblogSum/pageList" ,
            type:"post",
	        data : function ( d ) {
	        	var obj = {};
	    ...
	    "columns": [
					...
					{ "data": 'appName', "width":'20%'},
					{ "data": 'jobDesc', "width":'20%'},
					{ "data": 'executorHandler', "width":'30%'},
					{ "data": 'count', "width":'10%'}
	...
	// logTips alert
	$('#joblogSum_list').on('click', '.logTips', function(){
	...
	// logDetail look
	$('#joblogSum_list').on('click', '.logDetail', function(){
	 ...
	 * log Kill
	 */
	$('#joblogSum_list').on('click', '.logKill', function(){
		var _id = $(this).attr('_id');
