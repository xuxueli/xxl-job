	    ...
	    <section class="content">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
			            <div class="box-body">
			              	<table id="joblogSum_list" class="table table-bordered table-striped display" width="100%" >
				                <thead>
					            	<tr>
                                        <th name="jobId" >${I18n.jobinfo_field_id}</th>
                                        <th name="appName" >${I18n.jobgroup_field_title}</th>
                                        <th name="jobDesc" >${I18n.job_desc}</th>
                                      	<th name="executorHandler" >${I18n.executor_handler}</th>
                                        <th name="count" >${I18n.do_count}</th>
					                </tr>
				                </thead>
				                <tbody></tbody>
							</table>
...
<script src="${request.contextPath}/static/js/joblogSum.index.1.js"></script>
</body>
</html>
