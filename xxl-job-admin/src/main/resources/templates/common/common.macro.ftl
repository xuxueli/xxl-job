	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "alarminfo">active</#if>" ><a href="${request.contextPath}/alarminfo"><i class="fa fa-circle-o text-yellow"></i><span>${I18n.alarm_name}</span></a></li>
