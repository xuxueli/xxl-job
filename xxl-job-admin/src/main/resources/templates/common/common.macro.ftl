	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "joblogSum">active</#if>" ><a href="${request.contextPath}/joblogSum"><i class="fa fa-circle-o text-green"></i><span>${I18n.joblogSum_name}</span></a></li>
