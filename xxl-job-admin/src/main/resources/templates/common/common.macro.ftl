	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "warninfo">active</#if>" ><a href="${request.contextPath}/warninfo"><i class="fa fa-circle-o text-yellow"></i><span>${I18n.warning_name}</span></a></li>
