	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li class="nav-click <#if pageName == "jobrelation">active</#if>" ><a href="${request.contextPath}/jobrelation"><i class="fa fa-circle-o text-yellow"></i><span>${I18n.jobrelation_name}</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>OCS-JOB</b> ${I18n.admin_version}
		<div class="pull-right hidden-xs">
            <strong>Copyright &copy; ${.now?string('yyyy')}~ &nbsp;
                <!-- <a href="https://www.xuxueli.com/" target="_blank" >OCS</a> -->
				&nbsp;
