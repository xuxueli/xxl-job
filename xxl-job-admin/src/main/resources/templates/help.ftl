...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1><@spring.message code="job_help" /></h1>
		</section>

		<!-- Main content -->
		<section class="content">
			<div class="callout callout-info">
				<h4><@spring.message code="admin_name_full" /></h4>
				<br>
				<p>
					...
					<br><br>
                    <a target="_blank" href="http://www.xuxueli.com/xxl-job/"><@spring.message code="job_help_document" /></a>
                    <br><br>
