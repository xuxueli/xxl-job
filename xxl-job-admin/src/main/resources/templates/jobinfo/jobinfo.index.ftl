			...
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmhooktype}<font color="red">*</font></label>
                        <div class="col-sm-4">
                            <select class="form-control scheduleType" name="alarmHookType" >
                                <option value="telegram" >telegram</option>
                            </select>
                        </div>
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarmhookurl}<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="alarmHookUrl" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_alarmhookurl}" maxlength="100" ></div>
                    </div>
