			              	...
			              	<table id="job_list" class="table table-bordered table-striped" width="100%" >
				                <thead>
					            	<tr>
					            		...
					            		<th name="uniqName" >${I18n.jobinfo_field_uniqname}</th>
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					<div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_uniqname}<font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="uniqName" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_uniqname}" maxlength="50" ></div>
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			<div class="modal-header">
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					<div class="form-group">
                        <label for="uniqName" class="col-sm-2 control-label">${I18n.jobinfo_field_uniqname}<font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="uniqName" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_uniqname}" maxlength="50" ></div>
                    </div>
					<div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">${I18n.jobinfo_field_jobgroup}<font color="red">*</font></label>
