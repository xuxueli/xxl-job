...
public class RemotingUtil {
    ...
    public static ReturnT postBody(String url, int timeout, Object requestObj) {
        ...
        try {
            ...
            if (statusCode != 200) {
                return new ReturnT<String>(ReturnT.FAIL_CODE, "remoting fail, StatusCode("+ statusCode +") invalid. for url : " + url);
            }
            ...
            logger.error(e.getMessage(), e);
            return new ReturnT<String>(ReturnT.FAIL_CODE, "remoting error("+ e.getMessage() +"), for url : " + url);
        } finally {
            try {
