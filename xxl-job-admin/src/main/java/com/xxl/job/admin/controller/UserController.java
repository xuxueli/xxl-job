...
public class UserController {
    ...
    public Map<String, Object> pageList(@RequestParam(required = false, defaultValue = "0") int start,
        ...
        // page list
        IPage<XxlJobUser> page = xxlJobUserService.page(start, length, username, role);
    ...
    public ReturnT<String> add(XxlJobUser xxlJobUser) {
        ...
        // write
        xxlJobUserService.save(xxlJobUser);
    ...
    public ReturnT<String> update(HttpServletRequest request, XxlJobUser xxlJobUser) {
        ...
        // write
        xxlJobUserService.updateById(xxlJobUser);
        return ReturnT.SUCCESS;
    }
    ...
    public ReturnT<String> remove(HttpServletRequest request, int id) {
        ...
        xxlJobUserService.removeById(id);
        return ReturnT.SUCCESS;
    }
    ...
    public ReturnT<String> updatePwd(HttpServletRequest request, String password) {
        ...
        xxlJobUserService.updateById(existUser);
