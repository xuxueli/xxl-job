                ...
                while (!toStop) {
                    try {
                        ...
                        if (groupList != null && !groupList.isEmpty()) {
                            ...
                            List<Integer> ids = XxlJobAdminConfig.getAdminConfig().getXxlJobRegistryMapper().findDead(deadTime);
                            ...
                            List<XxlJobRegistry> list = XxlJobAdminConfig.getAdminConfig().getXxlJobRegistryMapper().findAll(deadTime);
                            if (list != null) {
