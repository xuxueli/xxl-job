...
public class XxlJobServiceImpl implements IXxlJobService {
    ...
    @Override
    public Map<String, Object> pageList(int start, int length, String jobGroup, String jobName,
                                        String filterTime) {
    ...
    public ReturnT<String> add(String jobGroup, String jobName, String jobCron, String jobDesc,
                               ...
                               String author, String alarmEmail, int alarmThreshold, int jobType,
                               String jobPath) {
        // valid
        ...
        if (jobType == 0 && StringUtils.isBlank(executorHandler)) {
