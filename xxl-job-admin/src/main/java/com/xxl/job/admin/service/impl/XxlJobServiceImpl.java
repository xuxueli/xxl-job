...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public Map<String, Object> pageList(int start, int length, int jobGroup, String jobDesc, String executorHandler,
        ...
        // page list
        List<XxlJobInfo> list = xxlJobInfoDao.pageList(start, start + length, jobGroup, jobDesc, executorHandler);
            ...
            for (String childJobIdItem : childJobIds) {
                if (StringUtils.isNotBlank(childJobIdItem) && StringUtils.isNumeric(childJobIdItem)) {
                    ...
                    if (childJobInfo == null) {
                        return new ReturnT<String>(ReturnT.FAIL_CODE,
                                                   MessageFormat
                                                           .format((I18nUtil.getString("jobinfo_field_childJobId")
                                                                    + "({0})" + I18nUtil.getString("system_not_found")),
                                                                   childJobIdItem));
                    }
                } else {
                    return new ReturnT<String>(ReturnT.FAIL_CODE,
                                               MessageFormat.format(
                                                                    (I18nUtil.getString("jobinfo_field_childJobId")
                                                                     + "({0})" + I18nUtil.getString("system_unvalid")),
                                                                    childJobIdItem));
                }
            }
    ...
    public ReturnT<Map<String, Object>> chartInfo(Date startDate, Date endDate) {
        /*
         * // get cache
         * String cacheKey = TRIGGER_CHART_DATA_CACHE + "_" +
         * startDate.getTime() + "_" + endDate.getTime();
         * Map<String, Object> chartInfo = (Map<String, Object>)
         * LocalCacheUtil.get(cacheKey);
         * if (chartInfo != null) {
