...
public class JobLogController {
    ...
    public String index(HttpServletRequest request, Model model, @RequestParam(required = false, defaultValue = "0") Integer jobId) {
        ...
        // 执行器列表
        List<XxlJobGroup> jobGroupList_all = xxlJobGroupService.list();
    ...
    public ReturnT<List<XxlJobInfo>> getJobsByGroup(int jobGroup) {
        List<XxlJobInfo> list = xxlJobInfoService.getJobsByGroup(jobGroup);
    ...
    public Map<String, Object> pageList(HttpServletRequest request,
        ...
        // page query
        IPage<XxlJobLog> page = xxlJobLogService.page(start, length, jobGroup, jobId, triggerTimeStart, triggerTimeEnd, logStatus);
        List<XxlJobLog> list = page.getRecords();
    ...
    public ReturnT<LogResult> logDetailCat(String executorAddress, long triggerTime, long logId, int fromLineNum) {
        try {
            ...
            if (logResult.getContent() != null && logResult.getContent().getFromLineNum() > logResult.getContent().getToLineNum()) {
                XxlJobLog jobLog = xxlJobLogService.getById(logId);
