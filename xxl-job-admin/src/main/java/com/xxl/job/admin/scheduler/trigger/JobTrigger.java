...
public class JobTrigger {
    ...
    private void processTrigger(XxlJobGroup group,
        ...
        logger.debug(">>>>>>>>>>> xxl-job trigger start, jobId:{},jobLogId:{}", jobLog.getJobId(), jobLog.getId());
        ...
        logger.debug(">>>>>>>>>>> xxl-job trigger end, jobId:{},jobLogId:{}", jobLog.getJobId(), jobLog.getId());
    }
