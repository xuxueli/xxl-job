...
public class JobGroupController {
    ...
    private List<String> findRegistryByAppName(String appNameParam) {
        ...
        List<XxlJobRegistry> list =
                XxlJobAdminConfig.getAdminConfig().getXxlJobRegistryDao().findAll(Date.from(LocalDateTime.now()
                        .minusSeconds(RegistryConfig.DEAD_TIMEOUT).atZone(ZoneId.systemDefault()).toInstant()));
        if (list != null) {
