...
(
    ...
    "UPDATE_TIME"     DATE,
    "AUTHOR" VARCHAR2 (128),
    "ALARM_EMAIL" VARCHAR2 (1024),
    "SCHEDULE_TYPE" VARCHAR2 (200) DEFAULT 'NONE' NOT NULL,
    "SCHEDULE_CONF" VARCHAR2 (512),
    "MISFIRE_STRATEGY" VARCHAR2 (200) DEFAULT 'DO_NOTHING' NOT NULL,
    "EXECUTOR_ROUTE_STRATEGY" VARCHAR2 (200),
    "EXECUTOR_HANDLER" VARCHAR2 (1024),
    "EXECUTOR_PARAM" VARCHAR2 (2000),
    "EXECUTOR_BLOCK_STRATEGY" VARCHAR2 (200),
    "EXECUTOR_TIMEOUT" NUMBER (20,0) DEFAULT 0 NOT NULL,
    "EXECUTOR_FAIL_RETRY_COUNT" NUMBER (20,0) DEFAULT 0 NOT NULL,
    "GLUE_TYPE" VARCHAR2 (200) NOT NULL,
    "GLUE_SOURCE" CLOB,
    "GLUE_REMARK" VARCHAR2 (2000),
    "GLUE_UPDATETIME" DATE,
    "CHILD_JOBID" VARCHAR2 (1024),
...
(
    ...
    "EXECUTOR_ADDRESS" VARCHAR2 (1024),
    "EXECUTOR_HANDLER" VARCHAR2 (1024),
    "EXECUTOR_PARAM" VARCHAR2 (2000),
    "EXECUTOR_SHARDING_PARAM" VARCHAR2 (80),
    "EXECUTOR_FAIL_RETRY_COUNT" NUMBER (20,0) DEFAULT 0 NOT NULL,
    "TRIGGER_TIME" DATE,
...
(
    "ID" NUMBER (20,0) NOT NULL,
    "JOB_ID" NUMBER (20,0) NOT NULL,
    "GLUE_TYPE" VARCHAR2 (200),
    "GLUE_SOURCE" CLOB,
    "GLUE_REMARK" VARCHAR2 (512) NOT NULL,
    "ADD_TIME"    DATE,
    "UPDATE_TIME" DATE,
    PRIMARY KEY ("ID")
);
...
(
    "ID" NUMBER (20,0) NOT NULL,
    "REGISTRY_GROUP" VARCHAR2 (200) NOT NULL,
    "REGISTRY_KEY" VARCHAR2 (1024) NOT NULL,
    "REGISTRY_VALUE" VARCHAR2 (1024) NOT NULL,
    "UPDATE_TIME" DATE,
    PRIMARY KEY ("ID")
);
