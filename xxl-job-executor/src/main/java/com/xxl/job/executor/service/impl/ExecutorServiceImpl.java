...
import com.xxl.job.executor.factory.gluetype.GlueTypeExecutorFactory;
...
public class ExecutorServiceImpl implements ExecutorService {
    ...
    @Autowired
    private GlueTypeExecutorFactory glueTypeExecutorFactory;
    ...
    @Override
    public ResponseVO<Void> idleBeat(IdleBeatParam idleBeatParam) {
    ...
    @Override
    public ResponseVO<Void> run(TriggerParam triggerParam) {
        return glueTypeExecutorFactory.runTrigger(triggerParam);
    }
...
//    }
    ...
    @Override
    public ResponseVO<Void> kill(KillParam killParam) {
